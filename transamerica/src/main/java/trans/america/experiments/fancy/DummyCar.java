...
public class DummyCar extends Node implements ActionListener {
    ...
    DummyCar(final Node rootNode, final AssetManager assetManager, final PhysicsSpace physicsSpace) {
        super("vehicleNode");
        ...
        this.rotate(0, FastMath.PI, 0); // tmp
